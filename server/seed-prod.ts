...
const members = [
  ...
  { id: 'm3',  name: 'Huang Xue',        initials: 'HX', phone: '', email: 'huang@crunchtime.app',    color: '#F39C12' },
  { id: 'm4',  name: 'Jeffrey Chen',     initials: 'JC', phone: '', email: 'jeffrey@crunchtime.app',  color: '#2ECC71' },
  { id: 'm5',  name: 'Jon Tan',          initials: 'JT', phone: '', email: 'jon@crunchtime.app',      color: '#1ABC9C' },
  { id: 'm6',  name: 'Matthew Tse',      initials: 'MT', phone: '', email: 'mtse9779@gmail.com',      color: '#3498DB' },
  { id: 'm7',  name: 'Michelle Song Vo', initials: 'MS', phone: '', email: 'michelle@crunchtime.app', color: '#E74C3C' },
  { id: 'm8',  name: 'Mike Luo',         initials: 'ML', phone: '', email: 'mike@crunchtime.app',     color: '#27AE60' },
  { id: 'm9',  name: 'Sandy Feng',       initials: 'SF', phone: '', email: 'sandy@crunchtime.app',    color: '#E67E22' },
  { id: 'm10', name: 'Simon Fan',        initials: 'SF', phone: '', email: 'simon@crunchtime.app',    color: '#8E44AD' },
  { id: 'm11', name: 'Yana Liu',         initials: 'YL', phone: '', email: 'yana@crunchtime.app',     color: '#16A085' },
]
