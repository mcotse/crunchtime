...
- Tabs without a BalanceHeader (home, polls, calendar) need `pt-14` top padding to clear the absolute-positioned settings icon. Always account for this when adding new tabs.
